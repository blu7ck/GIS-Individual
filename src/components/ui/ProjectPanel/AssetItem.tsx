...
import { getLayerTypeStyle } from './layerTypeConfig.ts';
        ...
        <div className="group flex items-center justify-between p-1.5 rounded hover:bg-[#57544F]/20 transition">
            <div className="flex items-center overflow-hidden flex-1">
                ...
                {isEditing ? (
                    ...
                    <span
                        className={`text-xs truncate flex-1 text-carta-mist-300 cursor-pointer ${hoverColor} transition-all duration-200 ${asset.type === LayerType.TILES_3D ? 'underline' : ''}`}
                        title={asset.name}
                        onClick={handleClick}
